  ...
  return (
    <Box minHeight="95vh">
      <Stack direction={{ xs: "column", md: "row" }}>
        <Box flex={1} style={{ width: '100vw' }}>
          <Box sx={{ width: {xs:'90vw', md:'75vw'}, position: "sticky", top: "86px" }}>
            ...
            <Stack direction="row" justifyContent="space-between" sx={{ color: "#fff" }} py={1} px={2} >
              <Link to={`/channel/${channelId}`}>
                <Typography variant={{ sm: "subtitle1", md: 'h5' }} color="#fff" >
                  {channelTitle}
                  <VerifiedIcon sx={{ fontSize: "12px", color: "gray", ml: "5px" }} />
                </Typography>
              </Link>
        ...
        <Box px={2} py={{ md: 1, xs: 5 }} justifyContent="center" alignItems="center" >
          <Typography color="#dedede" variant="h6" fontWeight="bold" px={3} py={1}>
            <MovieIcon style={{position:'relative', top:'6px' }} /> Related:
          </Typography>
